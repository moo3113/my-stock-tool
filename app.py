            ...
            if price and not pd.isna(price):
                ...
                <div style="font-family: -apple-system, sans-serif; background: white; padding: 15px; border-radius: 25px; color: #333;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 16px; margin-bottom: 25px;">
                        ...
                        <tr style="border-bottom: 1px solid #eee; color: #cc0000;"><td style="padding: 12px 5px; font-weight: bold;">1.7 神獸位階</td><td style="text-align: right; font-weight: bold;">{t3:.2f}</td></tr>
                    </table>
                    ...
                    <div style="background: #fff9c4; padding: 20px; border-radius: 20px; border: 3px solid #fbc02d; margin-top: 10px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: 12px;">
                            <div style="background: white; padding: 15px; border-radius: 12px; border-left: 5px solid #fbc02d; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                            ...
                            <div style="background: white; padding: 15px; border-radius: 12px; border-left: 5px solid #fbc02d; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                                ...
                                <div style="font-size: 13px; color: #666; margin-top: 4px;">偵測 <b>股價 > 月線 > 季線</b> 的黃金排列。</div>
                            </div>
                            <div style="background: white; padding: 15px; border-radius: 12px; border-left: 5px solid #fbc02d; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                ...
                '''
                components.html(full_card_html, height=1700, scrolling=True)
            else:
                st.error("❌ 抓取數據失敗。")
